CREATE TABLE IF NOT EXISTS ${schema_name}.raster25m_dhm (
...
INSERT INTO ${schema_name}.raster25m_dhm(rast)
VALUES
(
  --ST_Tile(
    ST_AddBand(
...
CREATE INDEX ${schema_name}_raster25m_dhm_rast_gist_idx ON ${schema_name}.raster25m_dhm USING GIST (ST_ConvexHull(rast));
