CREATE TABLE IF NOT EXISTS ${schema_name}.raster25m_nagra (
...
INSERT INTO ${schema_name}.raster25m_nagra(rast)
VALUES
(
  --ST_Tile(
    ST_AddBand(
...
CREATE INDEX ${schema_name}_raster25m_nagra_rast_gist_idx ON ${schema_name}.raster25m_nagra USING GIST (ST_ConvexHull(rast));
