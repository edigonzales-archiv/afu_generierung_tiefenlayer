CREATE TABLE IF NOT EXISTS ${schema_name}.raster25m_lockergestein_basis (
...
-- Do not tile at the moment since assigning values from point grid is much faster.
INSERT INTO ${schema_name}.raster25m_lockergestein_basis(rast)
VALUES
(
  --ST_Tile(
    ST_AddBand(
...
CREATE INDEX ${schema_name}_raster25m_lockergestein_basis_rast_gist_idx ON ${schema_name}.raster25m_lockergestein_basis USING GIST (ST_ConvexHull(rast));
